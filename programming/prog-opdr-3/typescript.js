...
var typeoutput = 'voer een cijfer tussen 0 en 10 in';
function typeknop() {
    var typecijfer = parseInt(document.getElementById("typecijfer").value);
...
var typeoutputswitch;
function typeknopswitch() {
    var typecijferswitch = parseInt(document.getElementById("typecijferswitch").value);
    ...
    document.getElementById("typeoutputswitch").innerHTML = typeoutputswitch;
}
//opdracht 3 
var typePurchasedBook = true;
var typejob = 'teacher';
var typeInTrain = true;
